...
const I18N = {
  zh: {
    ...
    'team.empty':        '目前只有你一个人……',
    'team.more':         '+{n}人',
    'teams.deadline':    '截止: 明天',
    'teams.leader':      '上司: 进度呢？',
    'teams.pr':          'PR 要 review',
    'teams.meeting':     '会议 18:00',
    'log.title':         '── 今日记录 ──',
    ...
    'toast.clinic':          '🏥 打完点滴，可以工作了',
    'pachinko.enter':         '走进柏青哥店。\n就一把……反正很快就出来。\n选赌注：',
    'pachinko.leave':         '还是算了',
    'pachinko.result.lose':   '全部吞了。\n回头想这件事，肯定后悔的。\n……但真的差一点。',
    'pachinko.result.even':   '回本了。\n感觉像赢了，但什么都没发生。',
    'pachinko.result.small':  '小赢。\n还行。\n再来一把吧。',
    'pachinko.result.medium': '中奖！！\n感觉来了。',
    'pachinko.result.big':    '大赢！！！\n今天是好日子。\n趁热打铁？',
    'pachinko.result.jackpot':'🎰 大当たり！！！\n灯全亮了。\n机器疯了。\n你也疯了。',
    'pachinko.near_miss':     '差一点！！就差一个就大当たり……',
    'pachinko.craving_onset': '脑子里有个声音：「就一把而已……」',
    'pachinko.craving_heavy': '戒不掉了。\n你知道的。',
    'pachinko.retry':         '再来一把',
    'pachinko.quit':          '算了，回去',
    'pachinko.craving_log':   '🎰 脑子里又在响那个音效……（渴望度上升）',
    'pachinko.log.lose':      '输了。净亏：{net}',
    'pachinko.log.even':      '回本了。打了平手。',
    'pachinko.log.small':     '小赢 {net}',
    'pachinko.log.medium':    '中奖！{net}',
    'pachinko.log.big':       '大赢！！{net}',
    'pachinko.log.jackpot':   '🎉 大当たり！！！ {net}',
    'pachinko.story.title':   '大奖的那一夜',
    'pachinko.story.text':    '所有灯都亮了。\n硬币哗哗地流出来，{amt} 日元。\n旁边的大叔看着你，眼神里有羡慕，也有什么别的东西。\n你不敢和他对视。\n你们都知道自己在这里做什么。',
    'pachinko.story.reply':   '你把钱收好，走进东京的夜里。\n下次，就下次一定能再来一次。',
  ...
  en: {
    ...
    'team.more':         '+{n}',
    'teams.deadline':    'DUE: Tomorrow',
    'teams.leader':      'Boss: Progress?',
    'teams.pr':          'PR needs review',
    'teams.meeting':     'Meeting 18:00',
    ...
    'shop.free':         'Free',
    'shop.cat.daily':    '── Daily ──',
    'shop.cat.fun':      '── Entertainment ──',
    ...
    'toast.clinic':          '🏥 IV drip done. Back to work.',
    'pachinko.enter':         'You step into the pachinko parlor.\nJust one spin… you\'ll be out in five minutes.\nPick your bet:',
    'pachinko.leave':         'Actually, never mind.',
    'pachinko.result.lose':   'Gone. All of it.\nYou\'ll regret this later.\n…But you were so close.',
    'pachinko.result.even':   'Break even.\nFeels like a win. Nothing happened.',
    'pachinko.result.small':  'Small win.\nNot bad.\nMaybe one more.',
    'pachinko.result.medium': 'Medium win!!\nYou\'re on a roll.',
    'pachinko.result.big':    'Big win!!!\nToday is a good day.\nPress your luck?',
    'pachinko.result.jackpot':'🎰 JACKPOT!!!\nEvery light in the place is flashing.\nThe machine lost its mind.\nSo did you.',
    'pachinko.near_miss':     'So close!! One symbol off the jackpot…',
    'pachinko.craving_onset': 'A voice in your head: "Just one more…"',
    'pachinko.craving_heavy': 'You can\'t stop.\nYou know that now.',
    'pachinko.retry':         'One more',
    'pachinko.quit':          'Leave (go home)',
    'pachinko.craving_log':   '🎰 That sound effect is playing in your head again… (craving rising)',
    'pachinko.log.lose':      'Lost it all. Net: {net}',
    'pachinko.log.even':      'Broke even.',
    'pachinko.log.small':     'Small win {net}',
    'pachinko.log.medium':    'Won! {net}',
    'pachinko.log.big':       'Big win!! {net}',
    'pachinko.log.jackpot':   '🎉 JACKPOT!!! {net}',
    'pachinko.story.title':   'The Night of the Jackpot',
    'pachinko.story.text':    'All the lights came on at once.\nCoins poured out — {amt} yen.\nThe old man next to you watched with something like envy — and something else.\nYou didn\'t meet his eyes.\nYou both knew why you were here.',
    'pachinko.story.reply':   'You pocketed the money and walked back into Tokyo\'s night.\nNext time. You\'d definitely hit it next time.',
  ...
  ja: {
    ...
    'team.empty':        '今はあなただけ……',
    'team.more':         '+{n}人',
    'teams.deadline':    '締切: 明日',
    'teams.leader':      '上司: 進捗は？',
    'teams.pr':          'PRレビュー頼む',
    'teams.meeting':     '会議 18:00',
    'log.title':         '── 本日の記録 ──',
    ...
    'toast.clinic':          '🏥 点滴終了。仕事できる。',
    'pachinko.enter':         'パチンコ屋に入った。\nまあ一回だけ……どうせすぐ出るし。\n賭け金を選べ：',
    'pachinko.leave':         'やっぱりやめる',
    'pachinko.result.lose':   '全部飲まれた。\nあとで絶対後悔する。\n……でもあと一歩だったのに。',
    'pachinko.result.even':   '本が返ってきた。\n勝った気がするけど、何も起きてない。',
    'pachinko.result.small':  'ちょっと勝った。\nまあいいか。\nもう一回だけ。',
    'pachinko.result.medium': '中当たり！！\n流れが来てる。',
    'pachinko.result.big':    '大勝ち！！！\n今日はいい日だ。\n続ける？',
    'pachinko.result.jackpot':'🎰 大当たり！！！\nランプが全部点いた。\n台が狂った。\nあなたも狂った。',
    'pachinko.near_miss':     'あと一個！！惜しかった……',
    'pachinko.craving_onset': '頭の中で声がする：「一回だけ……」',
    'pachinko.craving_heavy': '止まれない。\n自分でもわかってる。',
    'pachinko.retry':         'もう一回',
    'pachinko.quit':          'やめる（帰る）',
    'pachinko.craving_log':   '🎰 あの効果音がまた頭に流れてる……（渇望度上昇）',
    'pachinko.log.lose':      '負けた。収支：{net}',
    'pachinko.log.even':      '本返ってきた。トントン。',
    'pachinko.log.small':     '小勝ち {net}',
    'pachinko.log.medium':    '当たった！{net}',
    'pachinko.log.big':       '大勝ち！！{net}',
    'pachinko.log.jackpot':   '🎉 大当たり！！！ {net}',
    'pachinko.story.title':   '大当たりの夜',
    'pachinko.story.text':    'ランプが全部点いた。\nコインが流れ出た——{amt}円。\n隣のおじさんが羨ましそうに、でも何か違う目で見ていた。\n目が合わなかった。\nお互いわかってた。ここで何をしているか。',
    'pachinko.story.reply':   'お金を回収して、東京の夜に出た。\n次は。次こそまた来る。',
