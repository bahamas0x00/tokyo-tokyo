...
const I18N = {
  zh: {
    ...
    'toast.energy_warn_2':   '有点累了，效率开始下降',
    'toast.energy_warn_1':   '越来越乏了……',
    'toast.energy_warn_0':   '快撑不住了，效率跌入谷底',
    'log.energy_warn_0':     '⚡ 体力告急——效率跌至谷底，赶紧去休息',
    'toast.collapse':        '💤 体力耗尽，趴桌睡死了',
    'toast.collapse_resting':'💤 趴桌睡着了，动不了',
    'toast.collapse_wake':   '头还是晕的……但好多了',
    'log.collapse':          '💤 体力透支，趴在桌上睡着了',
    ...
    'boss.catch.c2_penalty':  '第{n}次警告  快乐 −{hp}  健康 −{hlt}',
    'boss.catch.fine_penalty':'绩效扣了 {fine}，快乐 −8',
    'hr.warn.text':           `你收到一封日文邮件，主题栏里有你的名字。\n\n翻译软件告诉你：这是一封"改善计划通知"。\n\n上司坐在会议室里，等着你。`,
    'hr.warn.c1':             '（深吸一口气，推门进去）',
    'hr.warn.c1r':            '你点头、道歉、签了一张你看不懂的表格。\n出来的时候，走廊的荧光灯比平时更刺眼。',
    'hr.warn.log':            '📋 收到改善计划通知，被上司约谈',
    'hr.warn.penalty':        '快乐 −30  健康 −20  警告清零',
    'boss.catch.log':         '🫣 趴桌补觉被上司逮到了',
    'log.promoted':         '🎉 晋升为【{title}】！',
    'toast.promoted':       '🎉 晋升：{title}',
    'log.kohai_unlocked':   '👔 你成了小组长——现在可以在【设备升级】里招募後輩了',
    'review.text':          `人事考课的日子到了。\n\n上司翻着你的考勤表，\n上面密密麻麻全是加班记录。\n「○○くん，也熬了不少年头了。」`,
    'review.c1':            '「ありがとうございます」（深深鞠躬）',
    'review.c1r':           '你被晋升了。工资没涨多少，活倒是多了不少。',
    'review.c2':            '（不过是年功序列罢了）',
    'review.c2r':           '你心里清楚这套，但还是接受了晋升。社畜的资历，就是这么熬出来的。',
    'btn.bribe':            '💴 贿赂上司 {cost}',
    'toast.bribe_cd':       'HR 还盯着呢，过会儿再说',
    'bribe.ok.text':        `你把一个厚厚的信封塞进上司抽屉。\n\n他没说话，只是不动声色地把抽屉关上。`,
    'bribe.ok.r':           '第二天，你的座位牌悄悄换了头衔。没人提那个信封。',
    'bribe.ok.log':         '💴 贿赂奏效，晋升为【{title}】',
    'bribe.fail.text':      `你把信封递过去。\n\n上司接过，掂了掂，\n然后笑着说：「这个，我得上报一下。」`,
    'bribe.fail.r':         '钱原路退回，但你的名字进了某份名单。这个月别想好过。',
    'bribe.fail.log':       '🚨 贿赂翻车！上司收钱又举报，退款+背锅',
  ...
  en: {
    ...
    'toast.energy_warn_2':   'Getting tired — efficiency drops',
    'toast.energy_warn_1':   'Really worn out…',
    'toast.energy_warn_0':   'Running on fumes — barely functional',
    'log.energy_warn_0':     '⚡ Energy critical — efficiency at rock bottom. Go rest.',
    'toast.collapse':        '💤 Passed out at your desk',
    'toast.collapse_resting':'💤 Passed out — can\'t move',
    'toast.collapse_wake':   'Head\'s still spinning… but a bit better',
    'log.collapse':          '💤 Out of energy — you fell asleep at your desk',
    ...
    'boss.catch.c2_penalty':  'Warning #{n}  Mood −{hp}  Health −{hlt}',
    'boss.catch.fine_penalty':'Docked {fine} from your pay. Mood −8',
    'hr.warn.text':           'You receive an email in Japanese with your name in the subject line.\n\nThe translator says: "Performance Improvement Plan Notice."\n\nYour boss is waiting in the meeting room.',
    'hr.warn.c1':             '(Take a deep breath. Open the door.)',
    'hr.warn.c1r':            'You nod, apologize, and sign a form you can\'t read.\nThe hallway fluorescent lights feel harsher than usual on the way out.',
    'hr.warn.log':            '📋 Received a PIP notice. Called into a meeting.',
    'hr.warn.penalty':        'Mood −30  Health −20  Warnings reset',
    ...
    'review.text':          `Performance review day.\n\nYour boss flips through your attendance sheet—\nrow after row of overtime.\n"You've put in the years, haven't you."`,
    'review.c1':            '"Thank you, sir." (deep bow)',
    'review.c1r':           'You\'re promoted. The pay barely moves; the workload sure does.',
    'review.c2':            '(Just seniority, really.)',
    'review.c2r':           'You see through it, but take the promotion anyway. This is how a wage slave\'s tenure is earned.',
    'btn.bribe':            '💴 Bribe boss {cost}',
    'toast.bribe_cd':       'Lay low for now (HR is watching)',
    'bribe.ok.text':        `You slip a thick envelope into your boss's drawer.\n\nHe says nothing, just quietly slides it shut.`,
    'bribe.ok.r':           'Next day, the title on your desk plate quietly changed. Nobody mentions the envelope.',
    'bribe.ok.log':         '💴 Bribe worked — promoted to 【{title}】',
    'bribe.fail.text':      `You hand over the envelope.\n\nThe boss takes it, weighs it in his hand,\nthen smiles: "This... I'll have to report it."`,
    'bribe.fail.r':         'The money came back, but your name went on a list. This month will be hell.',
    'bribe.fail.log':       '🚨 Bribe backfired — he took it AND reported you. Refunded + blacklisted.',
  ...
  ja: {
    ...
    'toast.energy_warn_2':   'ちょっと疲れてきた…効率が落ちてる',
    'toast.energy_warn_1':   'もうへとへとだ…',
    'toast.energy_warn_0':   '限界が近い…効率が底まで落ちた',
    'log.energy_warn_0':     '⚡ 体力が危険水域——効率が底まで落ちた。休んでください',
    'toast.collapse':        '💤 体力切れ、机に突っ伏して寝てしまった',
    'toast.collapse_resting':'💤 机で寝てる、動けない',
    'toast.collapse_wake':   'まだ頭がぼーっとする…でも少しマシ',
    'log.collapse':          '💤 体力を使い果たし、机の上で寝てしまった',
    'toast.sick':            '🤒 倒れた。強制休養',
    ...
    'boss.catch.c2_penalty':  '警告{n}回目  気力 −{hp}  健康 −{hlt}',
    'boss.catch.fine_penalty':'{fine} 分の給与控除。気力 −8',
    'hr.warn.text':           '日本語のメールが届いた。件名に自分の名前がある。\n\n翻訳アプリによると「業務改善計画通知」らしい。\n\n上司が会議室で待っている。',
    'hr.warn.c1':             '（深呼吸して、ドアを開ける）',
    'hr.warn.c1r':            'うなずいて、謝って、読めない書類にサインした。\n廊下の蛍光灯が、いつもより眩しく感じた。',
    'hr.warn.log':            '📋 業務改善計画通知。上司に呼び出された',
    'hr.warn.penalty':        '気力 −30  健康 −20  警告リセット',
    'boss.catch.log':         '🫣 デスクで仮眠中に上司に見つかった',
    'log.promoted':         '🎉 【{title}】に昇進！',
    'toast.promoted':       '🎉 昇進：{title}',
    'log.kohai_unlocked':   '👔 リーダーになった——【設備強化】で後輩を募集できる',
    'review.text':          `人事考課の日がやってきた。\n\n上司が出勤表をめくる。\nびっしりと残業の記録。\n「○○くん、ずいぶん長く勤めたね。」`,
    'review.c1':            '「ありがとうございます」（深々と一礼）',
    'review.c1r':           '昇進した。給料はさほど上がらないが、仕事はぐっと増えた。',
    'review.c2':            '（しょせん年功序列か）',
    'review.c2r':           'からくりは分かっている。それでも昇進は受け入れた。社畜の年季は、こうして積まれる。',
    'btn.bribe':            '💴 賄賂 {cost}',
    'toast.bribe_cd':       'ほとぼりが冷めるまで待て',
    'bribe.ok.text':        `分厚い封筒を上司の引き出しに滑り込ませた。\n\n彼は何も言わず、静かに引き出しを閉めた。`,
    'bribe.ok.r':           '翌日、デスクの名札の肩書きがそっと変わっていた。封筒の話は誰もしない。',
    'bribe.ok.log':         '💴 賄賂成功、【{title}】に昇進',
    'bribe.fail.text':      `封筒を差し出す。\n\n上司は受け取り、重さを確かめ、\n笑って言った：「これは…報告しないとね。」`,
    'bribe.fail.r':         '金は戻ってきたが、名前はとあるリストに載った。今月は地獄だ。',
    'bribe.fail.log':       '🚨 賄賂が裏目！金を取って通報され、返金+冷遇',
